...
for i in sender_node_id:
  ...
  pandas library.
  '''
  inputFile= "../results/alpha_data/"+str(i)+"_format.txt"
  if (i >= 3 and i <= 12):
    outputFile = "../results/alpha_data/AlphaS1-"+str(i-2)+".png"

  if (i >= 13 and i <= 32):
    outputFile = "../results/alpha_data/AlphaS2-"+str(i-12)+".png"

  if (i >= 33 and i <= 42):
    outputFile = "../results/alpha_data/AlphaS3-"+str(i-32)+".png"
  ...
  plt.ylabel (ylabel)
  plt.title (title)
  plt.xticks(np.arange(13, 61, step=5))
  ...
  ax.set_xticklabels(('3', '8', '13', '18', '23', '28', '33', '38', '43', '48', '60'))
